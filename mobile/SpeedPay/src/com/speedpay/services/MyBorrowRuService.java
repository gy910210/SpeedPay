...
public class MyBorrowRuService implements Runnable{

	
	private final static String uri = "myBorrowClient";
	int user_id;
	Handler handler;
	
	
	
	public MyBorrowRuService() {
		super();
	}
	

	public MyBorrowRuService(int user_id, Handler handler) {
		super();
